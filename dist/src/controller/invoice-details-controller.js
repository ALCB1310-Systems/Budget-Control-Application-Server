...
exports.deleteInvoiceDetail = exports.getOneInvoiceDetail = exports.getAllInvoiceDetail = exports.createInvoiceDetail = void 0;
...
const getAllInvoiceDetail = (invoiceUUID, companyUUID) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getAllInvoiceDetail = getAllInvoiceDetail;
const getOneInvoiceDetail = (invoiceUUID, invoiceDetailUUID, companyUUID) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getOneInvoiceDetail = getOneInvoiceDetail;
const deleteInvoiceDetail = (invoiceUUID, detailUUID, companyUUID) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield queryRunner.startTransaction();
        const invoiceDetail = yield (0, exports.getOneInvoiceDetail)(invoiceUUID, detailUUID, companyUUID);
        if (!invoiceDetail) {
            yield queryRunner.rollbackTransaction();
            return false;
        }
        const budget = yield (0, budget_controller_1.getBudgetByItemAndProject)(invoiceDetail.budgetItem.uuid, invoiceDetail.invoice.project.uuid, invoiceDetail.company.uuid);
        if (!budget) {
            yield queryRunner.rollbackTransaction();
            return false;
        }
        ...
        const diff = budget.updated_budget - previousUpdatedBudget;
        if (budget.budgetItem.parent) {
            const nextBudget = yield (0, budget_controller_1.getBudgetByItemAndProject)(budget.budgetItem.parent.uuid, budget.project.uuid, budget.company.uuid);
            if (nextBudget)
                yield (0, budget_controller_1.saveBudgetWithSpent)(-invoiceDetail.total, diff, nextBudget, queryRunner);
        }
